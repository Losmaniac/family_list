 ...
 * banking. A curated multiple-choice set (edukační modul pro 5. třídu),
 * each paired with a kid-facing explanation — see
 * FinancialLiteracyExercise's `options`/`explanation` doc below for how
 * practice.tsx handles those.
 */
